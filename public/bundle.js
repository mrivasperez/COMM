...
var app = (function () {
    ...
    /* src/UI/MeetingItem.svelte generated by Svelte v3.24.1 */

    const file$1 = "src/UI/MeetingItem.svelte";
    ...
    function instance$1($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<MeetingItem> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("MeetingItem", $$slots, []);
    	return [];
    }

    class MeetingItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_each_block(ctx) {
    	let meetingitem;
    	let current;
    	meetingitem = new MeetingItem({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(meetingitem.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(meetingitem, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(meetingitem.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(meetingitem.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(meetingitem, detaching);
    		}
    	};
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, MeetingItem, meetings });
    	return [meetings];
    }
